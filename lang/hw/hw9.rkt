...
(define (call-method class-name method-name classes
                     obj arg-val)
  (type-case Class (find classes class-name)
    [(classC super-class field-names methods)
...
(define (isInstanceOf [classes : (Listof (Symbol * Class))] [search-class-name : Symbol] [class-name : Symbol]) : Boolean
  (if (eq? search-class-name class-name)
      #t
      (if (eq? class-name 'Object)
          #f
          (isInstanceOf classes search-class-name (classC-super-name (find classes class-name))))))
...
(module+ test
  ...
  (test (interp (multE (numE 10) (numE 7))
                empty (objV 'Object empty) (numV 0))
        (numV 70))
  (test (interp (selectE (numE 0) (newE 'Conditional empty))
                (list cond-class) (objV 'Object empty) (numV 0))
        (numV 0))
  (test (interp (selectE (numE 2) (newE 'Conditional empty))
                (list cond-class) (objV 'Object empty) (numV 0))
        (numV 1))
  ...
  (test/exn (interp-posn (newE 'Posn (list (numE 0))))
            "wrong field count")
  (test/exn (interp (selectE (thisE) (newE 'Conditional empty))
                    (list cond-class) (objV 'Object empty) (numV 0))
            "not a number")
  (test/exn (interp (selectE (numE 0) (numE 0))
                    (list cond-class) (objV 'Object empty) (numV 0))
            "not an object"))
    ...
    (type-case ExpI a
      ...
      [(superI method-name arg-expr)
       (ssendE (thisE)
               ...
               method-name
               (recur arg-expr))]
      [(selectI num-expr obj-expr) (selectE (recur num-expr) (recur obj-expr))]
      [(instanceOfI obj-expr class-name) (instanceOfE (recur obj-expr) class-name)])))
...
(module+ test
  ...
  (test (exp-i->c (selectI (numI 1) (newI 'Object (list (numI 1)))) 'Object)
        (selectE (numE 1) (newE 'Object (list (numE 1))))))
  ...
  (type-case Class (find classes-not-flat name)
    [(classC super-class field-names methods)
     (type-case Class (flatten-super name classes-not-flat i-classes)
       [(classC super-super-class super-field-names super-methods)
        (classC
         super-class
...
(module+ test
  ...
  (test (interp-prog (list `{class Fish extends Object
        ...
        `0)
  (test/exn (interp-prog empty `{instanceof {+ 1 2} Object})
            "not an object"))