...
\fbox{\parbox{\linewidth}{Open-page finish time with reordering: 217ns \\ \\
Closed-page finish time no reordering: 230ns \\ \\
For this set of requests, opened-page was a better policy choice. This was made possible by reordering requests to reduce how often the row buffer must be precharged.}}
